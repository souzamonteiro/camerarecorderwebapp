...
# Script to generate all the icons for the Camera Recorder PWA

echo "Generating icons for the Camera Recorder PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "short_name": "CameraRecorder",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "Record and save camera videos directly from your browser",
  "icons": [
    {
